...
# 80 accuracy running
# 65, 68, 60 new model
# above or equal to 70 then we can accept else we can reject ( thresold)
...
class ModelTrainer:
    ...
    #starting data loading,splitting in train & test, model training, model prediction,
    ...
    def initiate_model_trainer(self,)->artifact_entity.ModelTrainerArtifact:
        try:
            ...
            #saving all output to ModelTrainerArtifact class in artifact_entity.py file
            #prepare artifact
